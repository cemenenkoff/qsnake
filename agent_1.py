...
'''
# We want to plot some stats about how the algorithm learned to play.
...
if __name__ == '__main__':
    ...
    #   'coordinates', 'no direction', 'no body knowledge', and 'default',
    env = Snake(state_definition_type=state_definition_type)
    total_rewards_history = train_dqn(num_episodes, env)
    plot_history(total_rewards_history, name=f'{state_definition_type}-statedefn-{num_episodes}-episodes')
